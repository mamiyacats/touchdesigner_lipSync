...
public:
	...
	virtual int32_t	getNumInfoCHOPChans(void *reserved1)
	{
		return 0;
	}
	...
	virtual void	getInfoCHOPChan(int32_t index, OP_InfoCHOPChan* chan, void* reserved1)
	{
	}
	...
	virtual void getInfoDATEntries(
	  int32_t index,
	  int32_t nEntries,
